...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe_with_new_tags(self):
        ...
        self.assertEqual(res.status_code, status.HTTP_201_CREATED)
        recipes = Recipe.objects.filter(user=self.user)
        # make sure correct count of recipes was created
        self.assertEqual(recipes.count(), 1)
        recipe = recipes[0]
        self.assertEqual(recipe.tags.count(), 2)
        for tag in payload['tags']:
            # make sure user that tag name exist
            # and the correct user owns those tags
    ...
    def test_create_recipe_with_existing_tags(self):
        ...
        recipe = recipes[0]
        self.assertEqual(recipe.tags.count(), 2)
        # ensures that the specific tag was created exists
        # in the tags were assigned to the recipe
    ...
    def test_create_tag_on_update(self):
        ...
        # checking new_tag is exists in recipe
        # recipe.tags.all() will retrieve all recipe tags
